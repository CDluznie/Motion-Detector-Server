...
if __name__ == '__main__':
	...
	parser.add_argument("--networkDevice", default="wlan0", help="name of Wi-Fi card") # TODO REMOVE
	...
	print('PUBLIC SERVER ACCESSIBLE FROM :', utils.get_ip_address() + ':' + str(args.port))
